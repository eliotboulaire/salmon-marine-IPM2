### ============================================================================
### Creating table of Posterior Predictive Check on abundances
### ============================================================================
rm(list = ls())
...
nf_ppc_abund <- nimbleFunction(
  ...
  setup = function(model, samples, obsNodes, muNodes, sdFixed) {
    ...
    # member matrices, empty for now -- sized and filled inside run()
  ...
  run = function(samplesSub = double(2)) {
    ...
    # resize the member matrices to this run's dimensions
